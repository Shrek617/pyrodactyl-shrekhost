                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="pDescription" rows="4"
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-muted small">
                                Domain name that browsers will use to connect to your Node (e.g
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <div class="radio radio-danger radio-inline">
                                    <input type="radio" id="pSSLFalse" value="http" name="scheme" @if(request()->isSecure())
                                    disabled @endif>
                                    <label for="pSSLFalse"> Use HTTP Connection</label>
                                </div>
                            </div>
                            @if(request()->isSecure())
                                <p class="text-danger small">Your Panel is currently configured to use a secure connection. In
                                    order for browsers to connect to your node it <strong>must</strong> use a SSL connection.
                                </p>
                            @else
                                <p class="text-muted small">In most cases you should select to use a SSL connection. If using an
                                    IP Address or you do not wish to use SSL at all, select a HTTP connection.</p>
                            @endif
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <p class="text-muted small">Enter the directory where server files should be stored.
                                    <strong>If you use OVH you should check your partition scheme. You may need to use
                                        <code>/home/daemon-data</code> to have enough space.</strong></p>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <p class="text-muted small">The daemon runs its own SFTP management container and does not
                                    ...
                                    <code>8443</code> to allow websocket proxying over SSL.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="pSftpAliasAddress" class="form-label">SFTP Alias Address (Optional)</label>
                                <input type="text" name="sftp_alias_address" class="form-control" id="pSftpAliasAddress"
                                    value="{{ old('sftp_alias_address') }}" />
                                <p class="text-muted small">Overrides the default FQDN for SFTP connections shown to users.
                                </p>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="pSftpAliasPort" class="form-label">SFTP Alias Port (Optional)</label>
                                <input type="text" name="sftp_alias_port" class="form-control" id="pSftpAliasPort"
                                    value="{{ old('sftp_alias_port') }}" />
                                <p class="text-muted small">Overrides the default Daemon SFTP port shown to users.</p>
                            </div>
                        </div>
                    </div>
